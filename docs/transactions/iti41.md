...
* Each PRE item should refer to an MTP item that must be a [available](#FIXME), [approved](https://profiles.ihe.net/ITI/TF/Volume3/ch-4.2.html#4.2.3.2.2), [valid](#FIXME), [active](#FIXME) and for the same patient.
