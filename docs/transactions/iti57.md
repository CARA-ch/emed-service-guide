...
* Deleting an [APPC](https://www.ihe.net/uploadedFiles/Documents/ITI/IHE_ITI_Suppl_APPC.pdf) document means that the patient is opting out. It triggers an archive and removal of all the documents for this patient: [CH EMED EPR](https://fhir.ch/ig/ch-emed-epr/) and APPC (including and any deprecated ones) documents are both concerned.
