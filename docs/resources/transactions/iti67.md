...
This transaction provides an [MHD](https://profiles.ihe.net/ITI/MHD/index.html)-based alternative, as profiled by [CH EPR FHIR](https://fhir.ch/ig/ch-epr-fhir/index.html) to the [ITI-18 (Registry Stored Query)](iti18.md) transaction. Note that metadata and business logic constraints on ITI-18 for the eMedication service apply as well for this transaction.
