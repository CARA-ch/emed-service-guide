...
CARA's eMedication service Integration Guide uses different concepts, tools and conventions. This section lists resources that are useful for any eMedication integrator.

## Topics

* [Transactions](../resources/transactions/index.md): information about the implemented transactions.
* [Workflows](../resources/workflows/index.md): description of the different workflows clients of this service can follow.
* [CH EMED EPR](../references/emed/index.md): description of the eMedication [exchange format](https://fhir.ch/ig/ch-emed-epr/index.html).
* [PMP-APPC](../resources/appc/index.md): description of the policy file format.
* [OIDs](../references/oids/index.md): relevant OIDs to be used within the scope of the eMedication service.
* [Endpoints](../references/endpoints/index.md): the eMedication service endpoints available to clients.
...
* [EPR by example](https://github.com/ehealthsuisse/EPR-by-example): a repository of sample transactions, including documents and patients management, authentication etc.
