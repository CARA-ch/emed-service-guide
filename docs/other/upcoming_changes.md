## Currently Deployed
  ...
  - dev:
    - PMP (aggregator) v0.4.7 (deployed 2024-05-28, DB recreated with v0.4.0 deployed 2024-04-23), works with [CH EMED EPR 1.0.0](https://fhir.ch/ig/ch-emed-epr/index.html).
